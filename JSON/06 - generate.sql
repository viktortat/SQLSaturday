/*
   Скрипт демонстрирует генерацию JSON-данных из таблицы пользователей в SQL Server.
   Основные функции:
   - Создание и заполнение временной таблицы пользователей
   - Формирование JSON-выхода с помощью FOR JSON AUTO
   - Примеры структуры и форматирования результата
*/

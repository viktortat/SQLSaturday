/*
  Скрипт демонстрирует использование batch mode и columnstore-индекса для обработки JSON-данных в SQL Server.
  Основные функции:
  - Создание таблиц и вставка JSON-данных
  - Применение кластерного columnstore-индекса
  - Анализ эффективности хранения и обработки
  - Примеры работы с большими объёмами данных
*/

/*
    Скрипт сравнивает работу с JSON-данными в SQL Server 2016 и 2017.
    Основные функции:
    - Создание тестовых данных в различных форматах JSON
    - Сравнение производительности и возможностей обработки
    - Демонстрация различий в поддержке типов данных и функций
    - Анализ влияния версий SQL Server на работу с JSON
*/
SET NOCOUNT ON

/*
    Скрипт сравнивает производительность и способы извлечения данных из XML и JSON в SQL Server.
    Основные функции:
    - Создание тестовых данных в форматах XML и JSON
    - Многократное извлечение значений с помощью JSON_VALUE и XQuery
    - Замер времени выполнения операций
    - Сравнение подходов для анализа эффективности
*/
SET NOCOUNT ON

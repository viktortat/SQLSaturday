/*
     Скрипт демонстрирует различные типы сжатия данных (NONE, ROW, PAGE) для хранения JSON в SQL Server.
     Основные функции:
     - Создание временных таблиц с разными типами сжатия
     - Вставка и хранение JSON-данных
     - Сравнение производительности и эффективности сжатия
     - Анализ влияния сжатия на ресурсы и время выполнения
*/
SET NOCOUNT OFF
SET NOCOUNT OFF

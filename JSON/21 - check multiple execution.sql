/*
    Скрипт демонстрирует влияние многократного выполнения выражений при работе с XML и JSON в SQL Server.
    Основные функции:
    - Сравнение подходов к фильтрации данных в XML и JSON
    - Анализ производительности при повторном вычислении выражений

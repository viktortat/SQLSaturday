/*
    Скрипт сравнивает работу с большими данными в форматах XML и JSON в SQL Server (пример 2).
    Основные функции:
    - Загрузка данных из файлов XML и JSON
    - Сравнение производительности обработки и извлечения данных
    - Извлечение информации из сложных структур XML
    - Демонстрация подходов к анализу и обработке заказов и продуктов
*/
SET NOCOUNT ON

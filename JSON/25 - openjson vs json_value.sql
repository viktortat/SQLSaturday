/*
    Скрипт сравнивает производительность и подходы к фильтрации данных с помощью OPENJSON и JSON_VALUE в SQL Server.
    Основные функции:
    - Примеры фильтрации по свойству Color
    - Сравнение различных способов извлечения данных из JSON
    - Анализ времени выполнения для разных версий SQL Server
*/
SET NOCOUNT ON

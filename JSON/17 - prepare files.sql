...
/*
    Скрипт предназначен для подготовки файлов данных в форматах XML и JSON из базы AdventureWorks2014.
    Основные функции:
    - Создание хранимых процедур для генерации XML и JSON
    - Формирование структурированных данных о продуктах и заказах
    - Примеры конфигурации SQL Server для работы с xp_cmdshell
*/

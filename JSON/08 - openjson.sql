/*
    /*
        Скрипт демонстрирует использование функции OPENJSON для разбора и извлечения данных из JSON в SQL Server.
        Основные функции:
        - Примеры работы с объектами и массивами JSON
        - Извлечение и преобразование данных из различных структур JSON
        - Демонстрация типов данных, поддерживаемых OPENJSON
    */

/*
    Скрипт демонстрирует различные методы фильтрации данных с использованием JSON и строковых операций в SQL Server.
    Основные функции:
    - Примеры фильтрации с помощью OPENJSON и строковых функций
    - Создание временных таблиц и процедур для фильтрации
    - Сравнение подходов к обработке списков идентификаторов
*/

/*
  Скрипт демонстрирует хранение и структуру данных в форматах XML и JSON на примере информации о производителе и моделях ноутбуков.
  Основные функции:
  - Создание переменных с данными в формате XML и JSON
  - Сравнение структуры хранения данных
  - Подготовка данных для дальнейшего анализа или преобразования
*/

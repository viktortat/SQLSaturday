/*
    Скрипт демонстрирует различные методы разделения строк (split) в SQL Server, включая работу с большими строками.
    Основные функции:
    - Реализация split с помощью рекурсивного CTE
    - Использование XML, STRING_SPLIT и OPENJSON для разделения
    - Сравнение производительности и подходов
*/
SET NOCOUNT ON

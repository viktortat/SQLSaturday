/*
    Скрипт сравнивает работу с большими данными в форматах XML и JSON в SQL Server.
    Основные функции:
    - Загрузка данных из файлов XML и JSON
    - Сравнение производительности обработки разных типов данных
    - Извлечение информации из XML с помощью XQuery
    - Демонстрация подходов к анализу и обработке данных
*/
SET NOCOUNT ON

/*
    Скрипт предназначен для сравнения методов извлечения данных из XML и JSON в SQL Server.
    Основные функции:
    - Создание тестовых данных о пользователях в форматах JSON и XML
    - Демонстрация различных структур хранения
    - Подготовка данных для анализа производительности и функциональности XQuery и JSON_VALUE
*/
SET NOCOUNT ON

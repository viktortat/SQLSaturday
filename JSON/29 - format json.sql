/*
    /*
        Скрипт демонстрирует форматирование JSON-данных с помощью пользовательской CLR-функции в SQL Server.
        Основные функции:
        - Примеры настройки и создания CLR-ассембли
        - Использование функции FormatJSON_CLR для форматирования JSON
        - Работа с примерами JSON-структур
    */

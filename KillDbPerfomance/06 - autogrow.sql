/*
    Скрипт предназначен для анализа событий автодобавления файлов (autogrow) в SQL Server.
    Основные функции:
    - Получение информации о времени и длительности событий автодобавления
    - Определение типа файла (DATA/LOG)
    - Примеры изменения параметров FILEGROWTH
*/
SELECT StartTime

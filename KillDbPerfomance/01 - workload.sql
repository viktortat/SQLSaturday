/*
    Скрипт предназначен для моделирования нагрузки на тестовую базу данных KillDB в SQL Server.
    Основные функции:
    - Создание рабочих и логирующих таблиц
    - Генерация и вставка больших объёмов данных
    - Запись временных меток операций
    - Имитация длительной работы для анализа производительности
*/
USE KillDB
GO

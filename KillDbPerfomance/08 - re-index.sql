/*
    Скрипт предназначен для анализа и обслуживания индексов в базе данных KillDB в SQL Server.
    Основные функции:
    - Получение информации о размере, статистике и использовании индексов
    - Примеры анализа статистики и операций над индексами
    - Рекомендации по реиндексации для оптимизации производительности
*/
USE KillDB
GO

/*
    Скрипт предназначен для создания первого резервного копирования базы данных KillDB в SQL Server.
    Основные функции:
    - Выполнение полного и журнального бэкапа
    - Получение информации о состоянии базы через DBCC DBINFO
    - Анализ ключевых параметров резервного копирования
*/
USE [master]
GO

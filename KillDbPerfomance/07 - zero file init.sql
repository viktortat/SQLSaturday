/*
    Скрипт предназначен для демонстрации работы Instant File Initialization и её отключения в SQL Server.
    Основные функции:
    - Включение и отключение Instant File Initialization через TRACEON
    - Создание и удаление тестовой базы данных
    - Получение информации о сервисах и параметрах сервера
    - Анализ влияния параметра на скорость операций
*/
USE [master]
GO

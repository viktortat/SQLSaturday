/*
 Скрипт предназначен для демонстрации работы с вычисляемыми столбцами в таблице с Columnstore индексом.
 Основные функции:
 - Выполнение агрегаций с использованием вычисляемых выражений.
 - Сравнение производительности различных подходов к расчету итоговых значений.
 - Пояснение ограничений Columnstore индексов на использование вычисляемых столбцов.
*/
USE CCI
GO

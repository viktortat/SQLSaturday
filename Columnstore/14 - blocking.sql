/*
 Скрипт предназначен для демонстрации блокировок при работе с таблицами, содержащими Columnstore индексы.
 Основные функции:
 - Создание тестовой таблицы и Columnstore индекса.
 - Проведение транзакции с обновлением данных для моделирования блокировки.
 - Получение информации о текущих блокировках и их характеристиках.
*/
USE CCI
GO

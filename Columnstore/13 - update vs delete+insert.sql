/*
 Скрипт предназначен для сравнения производительности операций UPDATE и комбинации DELETE+INSERT в таблице с Columnstore индексом.
 Основные функции:
 - Выполнение массового обновления строк через UPDATE.
 - Моделирование удаления и повторной вставки данных через DELETE и INSERT.
 - Сравнение статистики времени и ввода-вывода для разных подходов к изменению данных.
*/
USE CCI
GO

/*
 Скрипт предназначен для демонстрации работы индексов на представлениях и особенностей использования Columnstore индексов в SQL Server.
 Основные функции:
 - Создание представления с агрегированными данными и индексация этого представления.
 - Пояснение ограничений на создание кластерных Columnstore индексов для представлений.
 - Создание некластерного Columnstore индекса на представлении.
 - Выполнение выборки с использованием индекса и анализ статистики выполнения.
*/
USE CCI
GO

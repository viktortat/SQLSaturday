/*
 Скрипт предназначен для анализа компрессии данных и структуры хранения в базе данных CCI.
 Основные функции:
 - Получение информации о размере и структуре таблиц и индексов.
 - Анализ состояния row group'ов в Columnstore индексах.
 - Оценка эффективности хранения и компрессии данных.
*/
USE CCI
GO

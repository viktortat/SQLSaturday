/*
 Скрипт предназначен для демонстрации работы режима пакетной обработки (Batch Mode) в SQL Server при использовании Columnstore индексов.
 Основные функции:
 - Создание таблицы с кластерным Columnstore индексом.
 - Выполнение группировок с различными режимами Batch Mode (ALLOW/DISALLOW).
 - Сравнение производительности запросов с Batch Mode и без него.
 - Анализ статистики времени и ввода-вывода для оценки эффективности Batch Mode.
*/
USE CCI
GO

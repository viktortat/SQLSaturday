/*
 Скрипт предназначен для демонстрации влияния вычисляемых скалярных выражений на производительность запросов в таблице с Columnstore индексом.
 Основные функции:
 - Выполнение группировки и агрегации с различными условиями фильтрации (CONVERT, арифметика, прямое сравнение).
 - Сравнение статистики времени и ввода-вывода для разных способов фильтрации.
 - Оценка влияния вычисляемых выражений на эффективность работы Columnstore индекса.
*/
USE CCI
GO

/*
 Скрипт предназначен для подготовки базы данных CCI для демонстрации работы с Columnstore индексами.
 Основные функции:
 - Удаление и пересоздание базы данных CCI с заданными параметрами файлов.
 - Перевод базы данных в режим SIMPLE recovery.
 - Создание таблицы dbo.tHeap с различными типами данных для дальнейших экспериментов.
*/
USE [master]
GO

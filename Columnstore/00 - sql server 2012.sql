/*
 Скрипт предназначен для демонстрации создания базы данных и таблицы с колонковым индексом в SQL Server 2012.
 Выполняет удаление и пересоздание базы данных, создание таблицы, добавление данных и создание некластерного колонкового индекса.
 Используется для ознакомления с возможностями Columnstore индексов в SQL Server 2012.
*/
USE [master]
GO

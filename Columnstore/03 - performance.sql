/*
 Скрипт предназначен для сравнения производительности различных типов хранения и компрессии данных в базе CCI.
 Основные функции:
 - Очистка буферов и включение статистики ввода-вывода и времени выполнения.
 - Выполнение агрегатных запросов к таблицам с разными типами хранения: Heap, NoCompress, RowCompress, PageCompress, Columnstore.
 - Сравнение статистики и времени выполнения для оценки эффективности Columnstore индексов.
*/
USE CCI

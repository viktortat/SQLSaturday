/*
    Скрипт демонстрирует различия и типичные ошибки при работе с временными таблицами и табличными переменными в SQL Server.
    Основные функции:
    - Сравнение поведения #temp таблиц и @table переменных
    - Влияние транзакций, области видимости и производительности
    - Примеры использования в курсорах и подзапросах
    - Анализ статистики и особенностей оптимизации запросов
*/
USE [master]
GO

/*
 Скрипт предназначен для демонстрации различных способов фильтрации по дате и их влияния на производительность в SQL Server.
 Основные функции:
 - Выполнение запросов с фильтрацией по дате с использованием разных функций и форматов.
 - Сравнение эффективности фильтрации с точки зрения использования индексов.
 - Примеры корректных и некорректных подходов к фильтрации по датам.
*/

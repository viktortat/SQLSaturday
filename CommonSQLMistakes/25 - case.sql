/*
    Скрипт демонстрирует особенности и типичные ошибки использования оператора CASE в SQL Server.
    Основные функции:
    - Примеры различных форм записи CASE (простая и поисковая)
    - Ошибки при повторяющихся условиях и обработке NULL
    - Использование CASE в пользовательских функциях
    - Демонстрация ошибок деления на ноль внутри CASE
*/

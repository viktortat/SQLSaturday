/*
 Скрипт предназначен для демонстрации ошибок, связанных с избыточным размером столбцов и влиянием на выделение памяти в SQL Server.
 Основные функции:
 - Создание таблиц с различными размерами строковых столбцов.
 - Сравнение поведения при выборке и вставке данных в таблицы разных размеров.
 - Показ влияния oversizing на производительность и ресурсы сервера.
*/
USE tempdb
GO

/*
     Скрипт демонстрирует создание, изменение и использование представлений (views) в SQL Server, а также типичные ошибки.
     Основные функции:
     - Примеры создания и обновления обычных и индексируемых представлений
     - Влияние изменений структуры таблиц на представления
     - Использование SCHEMABINDING и clustered index
     - Анализ производительности запросов через представления
*/
USE tempdb
GO

/*
 Скрипт предназначен для демонстрации проблемы parameter sniffing в SQL Server и её влияния на производительность запросов.
 Основные функции:
 - Выполнение запросов с разными значениями параметров для анализа поведения планов выполнения.
 - Создание и вызов процедуры с параметром для моделирования parameter sniffing.
 - Примеры использования DBCC FREEPROCCACHE и OPTION(RECOMPILE) для решения проблемы.
*/
SET NOCOUNT ON

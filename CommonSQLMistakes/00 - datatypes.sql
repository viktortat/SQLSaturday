/*
 Скрипт предназначен для демонстрации типичных ошибок при выборе и использовании типов данных в SQL Server.
 Основные функции:
 - Сравнение различных подходов к определению типов столбцов в таблицах.
 - Показ влияния выбора типа данных на корректность фильтрации и хранения.
 - Примеры некорректного и корректного использования типов для дат, булевых значений и строк.
*/

/*
 Скрипт предназначен для демонстрации проблем с оценкой кардинальности и влияния статистики на выполнение запросов в SQL Server.
 Основные функции:
 - Выполнение выборок с различными значениями фильтра для анализа кардинальности.
 - Показ работы с гистограммой статистики и параметрами трассировки.
 - Примеры обновления статистики и перестроения индексов для корректной оценки кардинальности.
*/
USE test
GO

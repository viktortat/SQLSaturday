/*
 Скрипт предназначен для демонстрации ошибок, связанных с отсутствием или некорректной работой механизма predicate pushdown в SQL Server.
 Основные функции:
 - Выполнение запросов с различными условиями фильтрации для анализа predicate pushdown.
 - Сравнение эффективности выполнения запросов с разными структурами WHERE и подзапросами.
 - Примеры создания и удаления индексов для оптимизации работы predicate pushdown.
*/
USE test
GO

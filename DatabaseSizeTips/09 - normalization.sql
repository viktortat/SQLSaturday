/*
 Скрипт предназначен для демонстрации принципов нормализации данных и структуры таблиц в SQL Server.
 Основные функции:
 - Создание и заполнение таблицы с отзывами о продуктах для анализа избыточности.
 - Примеры разделения данных на основные и детализированные таблицы для нормализации.
 - Сравнение структуры хранения до и после нормализации.
*/
USE tempdb
GO

/*
 Скрипт предназначен для демонстрации использования и преимуществ SPARSE-столбцов в SQL Server.
 Основные функции:
 - Создание таблиц с обычными и SPARSE-столбцами для сравнения.
 - Заполнение таблиц тестовыми данными с большим количеством NULL-значений.
 - Анализ эффективности хранения и экономии места при использовании SPARSE.
*/
USE tempdb
GO

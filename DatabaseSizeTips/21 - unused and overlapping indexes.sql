/*
 Скрипт предназначен для анализа неиспользуемых и перекрывающихся индексов в SQL Server.
 Основные функции:
 - Создание таблицы и различных индексов для анализа их использования.
 - Получение информации о перекрывающихся индексах и их столбцах.
 - Примеры оптимизации структуры индексов для повышения производительности и экономии ресурсов.
*/
USE tempdb
GO

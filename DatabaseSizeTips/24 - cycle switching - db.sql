/*
 Скрипт предназначен для демонстрации создания базы данных и управления файловыми группами для секционирования (partitioning) в SQL Server.
 Основные функции:
 - Удаление и пересоздание базы данных с нужными параметрами.
 - Динамическое создание файловых групп для секционирования.
 - Примеры автоматизации управления структурой базы данных через T-SQL.
*/
USE [master]
GO

/*
 Скрипт предназначен для демонстрации работы с индексами и анализа отсутствующих (missing) индексов в SQL Server.
 Основные функции:
 - Выполнение запросов для анализа необходимости создания индексов.
 - Получение информации о недостающих индексах через системные представления.
 - Примеры создания индексов и использования Database Engine Tuning Advisor.
*/
DBCC FREEPROCCACHE

/*
 Скрипт предназначен для демонстрации проблем избыточности данных и способов её устранения в SQL Server.
 Основные функции:
 - Создание и заполнение таблицы с избыточными записями.
 - Примеры группировки и выделения уникальных записей для устранения избыточности.
 - Сравнение структуры хранения до и после оптимизации.
*/
USE tempdb
GO

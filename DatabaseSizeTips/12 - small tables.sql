/*
 Скрипт предназначен для демонстрации работы с малыми таблицами и оптимизации хранения агрегированных данных в SQL Server.
 Основные функции:
 - Агрегация данных по месяцам и продуктам.
 - Создание и заполнение малой таблицы для хранения агрегированных значений.
 - Примеры обновления и использования малых таблиц для повышения производительности.
*/

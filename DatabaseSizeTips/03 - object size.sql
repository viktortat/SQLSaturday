/*
 Скрипт предназначен для анализа размера объектов базы данных (таблиц и представлений) в SQL Server.
 Основные функции:
 - Получение информации о размере, занятом и свободном пространстве для каждого объекта.
 - Анализ количества строк, индексов и партиций.
 - Формирование отчёта для оптимизации структуры хранения данных.
*/
SELECT 
	  o.[object_id]
	, s.name + '.' + o.name

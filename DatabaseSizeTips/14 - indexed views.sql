/*
 Скрипт предназначен для демонстрации работы индексированных представлений (indexed views) и их влияния на производительность запросов в SQL Server.
 Основные функции:
 - Создание и заполнение таблицы для анализа агрегированных данных.
 - Создание представления и индексов для оптимизации выборок.
 - Сравнение производительности запросов с использованием индексированных представлений и обычных индексов.
*/
USE tempdb
GO

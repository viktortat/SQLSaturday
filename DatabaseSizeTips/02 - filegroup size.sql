/*
 Скрипт предназначен для анализа размера файловых групп и файлов базы данных в SQL Server.
 Основные функции:
 - Получение информации о размере, занятом и свободном пространстве для каждого файла.
 - Анализ параметров роста и использования файловых групп.
 - Формирование отчёта для оптимизации хранения данных.
*/
SELECT
	  s.[file_id]
	, file_group = d.name
